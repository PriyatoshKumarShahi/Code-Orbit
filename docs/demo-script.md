...
I paste this message: 'Free recharge link sab users ko free data de raha hai, abhi click karo aur OTP dalo.'

The backend converts this into an embedding, searches Qdrant, and immediately finds that this is strongly similar to a scam pattern first seen in 2021.

Now instead of only saying 'fake', our system shows the credibility score, fake-risk meter, and a Misinformation Family Tree. That helps the user see that this same scam has returned again and again in new versions.
